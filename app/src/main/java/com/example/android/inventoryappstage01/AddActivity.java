package com.example.android.inventoryappstage01;
...
import com.example.android.inventoryappstage01.data.InventoryContract.InventoryEntry;
import com.example.android.inventoryappstage01.data.InventoryDbHelper;
        ...
        mProductSupplieNameSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    ...
                    } else if (selection.equals(getString(R.string.supplier_newegg))) {
